...
class SpotifyHomeForm(BaseForm):
    ...
    __search_btn = PyQualityServices.element_factory.get_button((By.XPATH, ("//*[contains(@class, 'search')]")), "Search")
    __search_box = PyQualityServices.element_factory.get_text_box(
        (By.XPATH, ("//*[contains(@class, 'encore-text') and contains(@data-testid, 'search-input')]")), "Search")
    __log_in_btn = PyQualityServices.element_factory.get_button(
